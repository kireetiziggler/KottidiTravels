        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 text-sm">
            ...
            <li className="flex gap-3 items-center">
              ...
              <a href="tel:9032264229" className="hover:text-white">+91 9032264229</a>
            </li>
            <li className="flex gap-3 items-center">
              <Mail size={18} className="text-brand-orange shrink-0"/>
              <a href="mailto:kottiditravelstirupati@gmail.com" className="hover:text-white">kottiditravels@gmail.com</a>
            </li>
          </ul>
        </div>
      </div>
