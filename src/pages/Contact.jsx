...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - Kottidi Travels Tirupati | Book Your Ride</title>
        <meta name="description" content="Get in touch with Kottidi Travels Tirupati. Call +91 8143015558 for instant booking, or send us a message for custom tour packages and car rentals." />
        <link rel="canonical" href="https://kottiditravelstirupati.in/contact" />
      </Helmet>
      ...
      <div className="bg-white pt-10 pb-20">
        <div className="page-container">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">kottiditravels@gmail.com</p>
                  </div>
                </div>
          ...
          <div className="mt-20 rounded-3xl overflow-hidden h-[300px] shadow-sm border border-gray-100">
             <iframe 
               title="Kottidi Travels Location"
