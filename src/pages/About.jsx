...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About Us - Kottidi Travels Tirupati | Premium Car Rental Service</title>
        <meta name="description" content="Kottidi Travels Tirupati is your trusted travel partner for pilgrimage journeys. Safe, reliable car rental and taxi services for Tirumala darshan and South India tours." />
        <link rel="canonical" href="https://kottiditravelstirupati.in/about" />
      </Helmet>
      
      <div className="bg-gradient-to-br from-brand-dark via-gray-900 to-brand-dark py-16 text-center text-white relative overflow-hidden">
      ...
      <div className="bg-white">
        <div className="page-container py-16 space-y-20">
          <section className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              <img 
                ...
                alt="Kottidi Travels journey and story" 
          ...
          <section className="bg-gradient-to-r from-brand-orange to-orange-500 rounded-[2.5rem] p-10 text-center text-white relative overflow-hidden shadow-xl">
            <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
